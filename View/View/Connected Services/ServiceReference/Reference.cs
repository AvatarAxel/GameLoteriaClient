...
namespace View.ServiceReference {
    ...
    public interface IAuthenticationService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IAuthenticationService/UserExist")]
        void UserExist(string username, string email);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IAuthenticationService/UserExist")]
        System.Threading.Tasks.Task UserExistAsync(string username, string email);
    }
    ...
    public partial class AuthenticationServiceClient : System.ServiceModel.DuplexClientBase<View.ServiceReference.IAuthenticationService>, View.ServiceReference.IAuthenticationService {
        ...
        public void UserExist(string username, string email) {
            base.Channel.UserExist(username, email);
        }
        
        public System.Threading.Tasks.Task UserExistAsync(string username, string email) {
            return base.Channel.UserExistAsync(username, email);
        }
    }
